"""
Django settings for django_instrumentor project.
...
SECRET_KEY = 'django-insecure-v&e+_u2%o*!8)q78(+(us1yrsn#z&#nljzwmj+g$4@xnyy=f2^'
...
ROOT_URLCONF = 'django_instrumentor.urls'
...
WSGI_APPLICATION = 'django_instrumentor.wsgi.application'
